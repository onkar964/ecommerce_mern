...
mongoose.connect("mongodb+srv://onkar964:007007007@cluster0.wd6xh2l.mongodb.net/e-commerce")
...
// creating polpular section in women
...
// removing products in cart data
...
app.post('/checkout', fetchUser, async (req, res) => {
    try {
        await Users.findOneAndUpdate({ _id: req.user.id }, { $set: { cartData: {} } });
